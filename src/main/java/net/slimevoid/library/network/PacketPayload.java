...
public class PacketPayload {
    ...
    public void append(PacketPayload other) {
        ...
        if (other.intPayload.length > 0) this.intPayload = concat(this.intPayload, other.intPayload);
        if (other.floatPayload.length > 0) this.floatPayload = concat(this.floatPayload, other.floatPayload);
        if (other.doublePayload.length > 0) this.doublePayload = concat(this.doublePayload, other.doublePayload);
        if (other.stringPayload.length > 0) this.stringPayload = concat(this.stringPayload, other.stringPayload);
        if (other.boolPayload.length > 0) this.boolPayload = concat(this.boolPayload, other.boolPayload);
    }
    ...
    public void splitTail(IndexInPayload index) {
        ...
        if (doublePayload.length > 0)
            System.arraycopy(doublePayload, index.doubleIndex, payload.doublePayload, 0, payload.doublePayload.length);
