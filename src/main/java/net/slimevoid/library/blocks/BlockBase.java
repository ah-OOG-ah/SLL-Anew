...
public abstract class BlockBase extends BlockContainer {
    ...
    public IIcon getIcon(int side, int metadata) {
        switch (side) {
            case 0:
                return this.bottom != null && metadata < this.tileEntityMap.length ? this.bottom[metadata]
                    : this.blockIcon;
            case 1:
                return this.top != null && metadata < this.tileEntityMap.length ? this.top[metadata] : this.blockIcon;
            case 3:
                return this.front != null && metadata < this.tileEntityMap.length ? this.front[metadata]
                    : this.blockIcon;
            default:
    ...
    public boolean removedByPlayer(World world, EntityPlayer player, int x, int y, int z) {
        ...
        TileEntityBase tileentitybase = (TileEntityBase) BlockHelper
            .getTileEntity(world, x, y, z, this.getTileMapData(metadata));
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess iblockaccess, int x, int y, int z) {
        ...
        TileEntityBase tileentitybase = (TileEntityBase) BlockHelper
            .getTileEntity(iblockaccess, x, y, z, this.getTileMapData(metadata));
        if (tileentitybase != null) {
    ...
    @Override
    public void addCollisionBoxesToList(World world, int x, int y, int z, AxisAlignedBB axisAlignedBB, List aList,
        Entity anEntity) {
        int metadata = world.getBlockMetadata(x, y, z);
        TileEntityBase tileentitybase = (TileEntityBase) BlockHelper
            .getTileEntity(world, x, y, z, this.getTileMapData(metadata));
    ...
    public final MovingObjectPosition superCollisionRayTrace(World world, int x, int y, int z, Vec3 startVec,
        Vec3 endVec) {
        return super.collisionRayTrace(world, x, y, z, startVec, endVec);
    }

    public final void superAddCollisionBoxesToList(World world, int x, int y, int z, AxisAlignedBB axisAlignedBB,
        List aList, Entity anEntity) {
        super.addCollisionBoxesToList(world, x, y, z, axisAlignedBB, aList, anEntity);
    }
    ...
    public final float superGetExplosionResistance(Entity par1Entity, World world, int x, int y, int z,
    ...
    public void breakBlock(World world, int x, int y, int z, Block block, int metadata) {
        TileEntityBase tileentity = (TileEntityBase) BlockHelper
            .getTileEntity(world, x, y, z, this.getTileMapData(metadata));
        if (tileentity != null) {
    ...
    @Override
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer entityplayer, int side, float xHit,
    ...
    public void setItemName(int metadata, String name) {
        ...
        if (item != null) {
            ((ItemBlockBase) item).setMetaName(
                metadata,
                (new StringBuilder()).append("tile.")
                    .append(name)
                    .toString());
        }
    }
    ...
    public TileEntity createTileEntity(World world, int metadata) {
        try {
            return (TileEntity) this.getTileMapData(metadata)
                .newInstance();
        } catch (Exception e) {
            return null;
        }
